...
STORY_INTROS = {
    ...
    "Саша": (
        "2 ночи. Небольшой бар с джазом — почти пустой. "
        "Бармен уже убирает стаканы и смотрит на часы. "
        "За стойкой — девушка с тёмными волосами. Сидит одна, смотрит в бокал. "
        "Явно давно здесь. Явно никуда не торопится. "
        "Ты — последний кто ещё не ушёл."
    ),
}
